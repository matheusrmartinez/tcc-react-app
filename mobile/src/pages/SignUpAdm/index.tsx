    ...
    async (data: SignUpFormData) => {
      try {
        ...
        const schema = Yup.object().shape({
          ...
          token: Yup.string().matches(/helio123/, 'Token inválido'),
        });
      ...
      >
        ...
        >
          <Container>
            <Image
              source={LogoImg}
              style={{ width: 150, height: 190, marginTop: 300 }}
            />
            <View>
              <Title>Crie sua conta administrador</Title>
            </View>
